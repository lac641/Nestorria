...
<div className=' flex flex-col mt-12 text-white'>
  <button className='max-w-90 flex items-center space-x-3 border border-white medium-13 rounded-full px-4 pr-0.5 py-1 cursor-pointer '>
    <span>Explore how we can simplify stays and spaces</span>
    <span className='flexCenter size-6 p-1 rounded-full bg-white'><img src={assets.right} alt="rightIcon" width={20}/></span>

  </button>

<h2 className='h2 capitalize leading-tight mt-3 my-2 text-white'> <span className='bg-gradient-to-r from-secondary to-white bg-clip-text text-transparent'>Explore exceptional properties </span> located in stunning surrondings </h2>
...
<input type="date" id='checkIn' className='rounded border border-gray-200 px-3
...
<input type="date" id='checkOut' className='rounded border border-gray-200 px-3
 py-1.5 mt-1.5 text-sm outline-none'/>
...
<input id='guests' type='number' min={1} max={5}   className='rounded border border-gray-200 px-3
 py-1.5 mt-1.5 text-sm outline-none' placeholder='0'/>
