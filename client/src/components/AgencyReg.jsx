        ...
        <div className="flex flex-col md:w-1/2 p-8 md:p-10">
          ...
          <div className="flex gap-2 xl:gap-3">
            <div>
              ...
              <input
                ...
                className="regular-14 border border-slate-900/10 rounded-lg bg-secondary/10 w-full px-3 py-1.5 mt-1 outline-none"
                required
              />
            </div>
          ...
          <div className="w-full mt-4 max-w-60 mr-auto">
            ...
            <select
              ...
              value={city}
              id="city"
              className="regular-14 border border-slate-900/10 rounded-lg bg-secondary/10 w-full px-3 py-2.5 mt-1 outline-none"
              required
            >
