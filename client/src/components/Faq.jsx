    ...
    const faqsData = [
        {
            ...
            answer: 'Designed with speed — Instant search and seamless property viewing.'
        },
        {
            question: 'Fully Customizable Homes',
            answer: 'Easily change layouts, features, and design to fit your lifestyle.'
        },
        {
...
<div className='flex-1 flex-col justify-cente'>
