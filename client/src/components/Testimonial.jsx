    ...
    <section className="max-padd-container py-16 xl:py-22">
      <>
        ...
        <div className="marquee-row  overflow-hidden relative">
          <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none  from-[#fffbee] to-transparent"></div>
          <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5">
            {[...cardsData, ...cardsData].map((card, index) => (
              <CreateCard key={index} card={card} />
            ))}
          </div>
          <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none b from-white to-transparent"></div>
        </div>
        ...
        <div className="marquee-row  overflow-hidden relative">
          ...
          <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none  from-white via-transparent
           to-transparent"></div>
        </div>
      </>
    </section>
