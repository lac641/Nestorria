...
{property.amenities.map((amenity, index)=>(
    <div key={index} className='py-3 rounded-lg bg-secondary/10 ring-1 ring-slate-500/10 text-sm'>
{amenity}
    </div>
))}
</div>
...
<input type="date" id='checkInDate' className='rounded border border-gray-200 px-3
...
<input type="date" id='checkOutDate' className='rounded bg-secondary/10 border border-gray-200  px-3
 py-1.5 mt-1.5 text-sm outline-none'/>
...
<input id='guests' type='number' min={1} max={5}   className='rounded bg-secondary/10 border border-gray-200  px-3
