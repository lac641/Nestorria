...
<div className="mt-4">
  <div className="flex justify-between flex-wrap gap-2 sm:grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-secondary border-b-1 border-slate-900/15 rounded-t-xl">
    <h5 className="h4 hidden lg:block ">Index</h5>
    <h5 className="h4">Property</h5>
    <h5 className="h4">Booking dates</h5>
...
{booking.property.title}</div>
        ...
        <div>{new Date(booking.checkInDate).
        toLocaleDateString()} to {new Date(booking.
        checkOutDate).toLocaleDateString()}</div>
