      ...
      <form className='flex flex-col gap-y-3.5 px-2 text-sm xl:max-w-3xl'>
        ...
        <div className='flex gap-4'>
         ...
         <div className='w-full'>
          ...
          <input onChange={(e)=>setInputs({...inputs, city: e.target.value})}
          value={inputs.city}
          type="text"
          placeholder='Type here...'
          className='px-3 py-1.5 ring-1 ring-slate-900/10 rounded-lg bg-secondary/5 mt-1 w-full'
         ...
         <div className='w-full'>
          ...
          <input onChange={(e)=>setInputs({...inputs, country: e.target.value})}
         ...
         <div >
          ...
          <select onChange={(e)=>setInputs({...inputs, propertyType: e.target.value})}
...
<h5 className='h5'>Address</h5>
  <input onChange={(e)=>setInputs({...inputs, address: e.target.value})}
...
<h5 className='h5'>Area</h5>
  <input onChange={(e)=>setInputs({...inputs, area: e.target.value})}
          value={inputs.area}
          type="number"
        ...
        <div className='flex gap-4 flex-wrap'>
          <div>
           ...
           <input onChange={(e)=>setInputs({...inputs, priceRent: e.target.value})}
          ...
          />
           ...
           <input onChange={(e)=>setInputs({...inputs, priceSale: e.target.value})}
          ...
          <div >
           ...
           <input onChange={(e)=>setInputs({...inputs, bedrooms: e.target.value})}
          ...
          />
           ...
           <input onChange={(e)=>setInputs({...inputs, bathrooms: e.target.value})}
          ...
          />
           ...
           <input onChange={(e)=>setInputs({...inputs, garages: e.target.value})}
    ...
    <label
     ...
     htmlFor={`propertyImage${key}`}
      ...
      <div className='h-12 w-24 bg-secondary/5 flexCenter'>
        ...
        alt="upload Area" className='overflow-hidden object-contain'/>
      </div>
    </label>
  ))}
</div>
